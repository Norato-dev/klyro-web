...
export function CTA() {
  return (
    <section className="mx-4 md:mx-12 mb-18 relative overflow-hidden rounded-3xl border border-cyan/[0.15] bg-white/[0.02] px-6 md:px-12 py-16 text-center">
      ...
      <p className="relative z-10 text-[18px] font-light text-ice-dim mb-9 leading-[1.7]">
        Cuéntanos tu idea y en 48 horas tienes una propuesta en tu bandeja.
        <br />
      ...
      <div className="relative z-10 flex flex-col sm:flex-row gap-3.5 justify-center items-center">
        ...
        <a
          href={`https://wa.me/573144147996?text=${encodeURIComponent("Hola Klyro, me gustaría hablar sobre mi proyecto web.")}`}
          target="_blank"
